...
module.exports = {
    ...
    codeNamespace: 'esls',                                             // Used as the name for concatenated macro, icon, and script files as well as the JSON tokens namespace and SCSS token prefix. If the namespace was 'esds' this would result in: esds.njk, esds.svg, esds.js, {{ esds.token_name }}, and $esds-token-name
    ...
    includeMarkdownWrapper: true,                                      // include a wrapper div when the nunjucks markdown filter is used
    markdownWrapperClass: 'esls-long-form-text',                         // wrapper class when nunjucks markdown filter is used               
    copyTasks: [
        {
        ...
        },
        {
            ...
            sources: [`node_modules/esds-doc/dist/esds-doc.js`,
    ...
    ],                                                      // Product specific set of tasks to copy a file from one destination to another. For copying jQuery from node_modules to the webroot as an example
    ...
    dependencies: [
        {
            ...
            tokens: 'reference'  // Could be 'copy', 'reference', 'merge', or 'overwrite': 'merge' and 'overwrite' behaviors not written yet
        },
        {
            moduleName: 'esds-doc',
            tokens: 'reference'  // Could be 'copy', 'reference', 'merge', or 'overwrite': 'merge' and 'overwrite' behaviors not written yet
