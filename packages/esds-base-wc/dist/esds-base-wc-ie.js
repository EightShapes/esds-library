var EsdsBaseWcIE = (function (exports) {
  'use strict';
  ...
  function _global() {
    var data = _interopRequireDefault(require("core-js/library/fn/global"));
  ...
  */
  ...
  function _templateObject2() {
    var data = _taggedTemplateLiteral(["<h1>You have to override me. I'm in the base EsdsBaseWc class!</h1>"]);
  ...
  function _templateObject() {
    var data = _taggedTemplateLiteral(["<link rel=\"stylesheet\" href=\"", "/", "\"/>"]);
  ...
  function (_LitElement) {
    _inherits(EsdsBaseWc, _LitElement);
    ...
    function EsdsBaseWc() {
      ...
      _classCallCheck(this, EsdsBaseWc);

      alert("TESTING");
      _this = _possibleConstructorReturn(this, _getPrototypeOf(EsdsBaseWc).call(this));
      console.log("ESDSBASEWC CALLED: ".concat(componentName)); // this.slotsExtracted = false;
    ...
    _createClass(EsdsBaseWc, [{
      key: "getStylesheet",
      value: function getStylesheet() {
        var stylesPath = window.stylesPath || '/styles';
        return html(_templateObject(), stylesPath, this.stylesheet);
      }
    }, {
      key: "render",
      value: function render() {
      ...
      value: function generateRandomNumber() {
        var max = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 100000000;
